    ...
    <>
      ...
      {item.unavailable && (
        <li className="d-flex align-items-center gap-3 mb-3">
          <p className="m-0">
            {event?.name} (id: {item.eventId}), ticket number: {item.ticketCount}
          </p>
        </li>
      )}
        ...
        <li className="row align-items-center g-3 mb-4">
          ...
          <div className="col-sm-9 d-flex flex-column align-items-stretch">
            ...
            <div className="d-flex justify-content-between align-items-center mb-auto">
              ...
              <p className="">
                from <span className="text-compl-300">{item.previousPrice}{'\u00A0€'}</span> to <span className="text-compl-300">{item.ticketPrice}{'\u00A0€'}</span>
              </p>
            </div>
